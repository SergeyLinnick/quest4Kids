...
export type DropdownMenuOptionType = IDropdownMenuOption & IDropdownMenuGroup;
...
const itemDropdownMenuVariants = cva(
  `focus:bg-accent
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(itemDropdownMenuVariants({ variant, size, className }))}
      {...props}
    />
  );
}
